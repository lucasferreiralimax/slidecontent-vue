  ...
  #app
    ...
    .example
      ...
      SlideContent(name="Exemplo 1" type="infinite" :nav="true" :animation="{ 'disabled': true }")
        ...
        SlideItem(class="favela actived" title="Fé em Deus" :img="require(`@/assets/faveladascriancas.jpg`)" url="https://www.instagram.com/p/B68pN_Ph9IZ" target="_blank")
      SlideSource
        | teste
    <!-- Exemplo slide simple -->
    .example
      h2(class="slide-title")
        ...
        span Slide sem navegação
      SlideContent(name="Exemplo 2" type="simple" :nav="false")
        SlideItem(class="actived" title="Ermelino Matarazzo" :img="require(`@/assets/ermelino.jpg`)" url="https://www.instagram.com/p/B7JoudZhHyv/")
        SlideItem(class="favela" title="Fé em Deus" :img="require(`@/assets/faveladascriancas.jpg`)" url="https://www.instagram.com/p/B68pN_Ph9IZ")
      SlideSource
        | teste
    <!-- Exemplo slide simple -->
    .example
      h2(class="slide-title")
        ...
        span Slide com duração de 10 segundos
      SlideContent(name="Exemplo 3" type="simple" :nav="true" :animation="{ direction: 'prev', time: 10000 }")
        SlideItem(class="actived" title="Ermelino Matarazzo" :img="require(`@/assets/ermelino.jpg`)" url="https://www.instagram.com/p/B7JoudZhHyv/" target="_blank")
        SlideItem(class="favela" title="Fé em Deus" :img="require(`@/assets/faveladascriancas.jpg`)" url="https://www.instagram.com/p/B68pN_Ph9IZ" target="_blank")
      SlideSource
        | teste
    SlideFooter
</template>
