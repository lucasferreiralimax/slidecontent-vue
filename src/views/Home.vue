...
section.page
  .example
    ...
    SlideContent(name="Exemplo 1" type="infinite" :nav="true" :animation="{ 'disabled': true }")
      SlideItem(:title="t('city')" img="/src/assets/ermelino.jpg" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
      SlideItem.favela.actived(:title="t('god_faith')" img="/src/assets/faveladascriancas.jpg" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
    SlideSource
      pre {{ example_1 }}
  .example
    h2.slide-title
    ...
    SlideContent(name="Exemplo 2" type="simple" :nav="false")
      SlideItem.actived(:title="t('city')" img="/src/assets/ermelino.jpg" url="https://github.com/lucasferreiralimax/slidecontent-vue")
      SlideItem.favela(:title="t('god_faith')" img="/src/assets/faveladascriancas.jpg" url="https://github.com/lucasferreiralimax/slidecontent-vue")
    SlideSource
      pre {{ example_2 }}
  .example
    h2.slide-title
    ...
    SlideContent(name="Exemplo 3" type="simple" :nav="true" :animation="{ direction: 'prev', time: 10000 }")
      SlideItem.actived(:title="t('city')" img="/src/assets/ermelino.jpg" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
      SlideItem.favela(:title="t('god_faith')" img="/src/assets/faveladascriancas.jpg" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
    SlideSource
      pre {{ example_3 }}
</template>
