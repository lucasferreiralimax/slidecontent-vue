  ...
  section.page
    .example
      ...
      SlideContent(name="Exemplo 1" type="infinite" :nav="true" :animation="{ 'disabled': true }")
        SlideItem(:title="$t('city')" :img="require(`@/assets/ermelino.jpg`)" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
        SlideItem.favela.actived(:title="$t('god_faith')" :img="require(`@/assets/faveladascriancas.jpg`)" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
      SlideSource
        pre {{ example_1 }}
    .example
      h2.slide-title
      ...
      SlideContent(name="Exemplo 2" type="simple" :nav="false")
        SlideItem.actived(:title="$t('city')" :img="require(`@/assets/ermelino.jpg`)" url="https://github.com/lucasferreiralimax/slidecontent-vue")
        SlideItem.favela(:title="$t('god_faith')" :img="require(`@/assets/faveladascriancas.jpg`)" url="https://github.com/lucasferreiralimax/slidecontent-vue")
      SlideSource
        pre {{ example_2 }}
    .example
      h2.slide-title
      ...
      SlideContent(name="Exemplo 3" type="simple" :nav="true" :animation="{ direction: 'prev', time: 10000 }")
        SlideItem.actived(:title="$t('city')" :img="require(`@/assets/ermelino.jpg`)" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
        SlideItem.favela(:title="$t('god_faith')" :img="require(`@/assets/faveladascriancas.jpg`)" url="https://github.com/lucasferreiralimax/slidecontent-vue" target="_blank")
      SlideSource
        pre {{ example_3 }}
</template>
...
const example_1 = (faith, city) => `SlideContent(
  name="Exemplo 1"
  type="infinite"
  :nav="true"
...
const example_2 = (faith, city) => `SlideContent(
  name="Exemplo 2"
  type="simple"
  :nav="false"
)
...
const example_3 = (faith, city) => `SlideContent(
  name="Exemplo 3"
  type="simple"
  :nav="true"
...
export default {
  ...
  data() {
    return {
      example_1: example_1(this.$t("god_faith"), this.$t("city")),
      example_2: example_2(this.$t("god_faith"), this.$t("city")),
      example_3: example_3(this.$t("god_faith"), this.$t("city")),
    }
  },
  components: {
    SlideContent,
